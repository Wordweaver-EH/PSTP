VAR arm_rising_score = 0
VAR hand_lock_score = 0
VAR book_hallucination_score = 0
VAR amnesia_score = 0

VAR arms_apart_score = 0
VAR hearing_voice_score = 0
VAR head_lowering_score = 0
VAR test_amnesia_score = 0
...
It was once commonly believed that giving subjects repeated instructions to go to sleep would cause them to go into a hypnotic trance. When in this trance, the subject was believed to come under the direct control of the hypnotist. The hypnotist was believed to take over the hypnotized subject's mind and body to do practically anything. The subject was thus viewed as an automaton or robot, fully subject to the commands of the hypnotist. This view of hypnosis is one of the great misconceptions in the history of psychology. Subjects in a hypnotic session are, in fact, fully awake and are in full control of all their actions.
+ [Continue]
-> intro_3
=== intro_3 ===
...
M: It's going up by itself. If feels hollow. I can see the pump. I can feel the arm being pumped up. It's
really light. It's moving up by itself. It just keeps getting lighter and is going up by itself. It's just
...
M: There it is. I can see it on the desk. I see the book sitting there. It's kind of vague and fuzzy ... a
...
M: It's funny. I can't seem to remember any of the suggestions. All I can feel is a real heaviness all over my
body, but especially in my feet. My feet are tingling, they're just heavy and tingling. It's a
funny sensation. It feels kind of nice. It reminds me of lying on the beach, letting the sun tan my body.
Watching the people go by and the children ....

H: Time's up. Now the memories are returning. They are becoming more and more clear. In fact, you can
remember all the suggestions that were presented. Write down all of the suggestions on the piece of paper
provided. Again, you will be given one minute to do so. (WAIT ONE MINUTE)
...
+ [Your hands move apart at least six inches]
    ~ arms_apart_score += 1
+ [Your hands move apart less than six inches]
...
=== hearing_voice ===
You are taking a course in the history of psychology and you are now in the classroom. In a moment, the professor will ask in what country Sigmund Freud was born. Of course, you know from your studies that it was Moravia. As you can hear, the professor is already asking several other questions about Freud, and he is just getting to the country of birth question, so get ready. In a few seconds, I want you to hear the professor ask Freud's birthplace and raise your hand to answer the question.

+ [You hear the professor's voice and raise your hand]
    ~ hearing_voice_score += 1
+ [You do not hear the professor's voice or raise your hand]

- Okay, he's calling on someone else. You can lower your hand. Perhaps he'll call on you in tomorrow's class. Keep your eyes closed and continue to relax.

+ [Continue]
-> head_lowering

=== head_lowering ===
Now, imagine that a force is pushing down on the top of your head, causing it to feel heavy. It feels like someone has placed the palm of their hand on the top of your head and is pushing downward. Your head is being pushed down with such force that your chin is moving toward your chest. The force continues to push, making your head feel heavier and heavier, making it fall forward more and more.

+ [Your head lowers noticeably]
    ~ head_lowering_score += 1
+ [Your head does not lower noticeably]
...
+ [You cannot remember the test suggestions]
    ~ test_amnesia_score += 1
+ [You can remember the test suggestions]
...
=== calculate_score ===
Your training session score: {arm_rising_score + hand_lock_score + book_hallucination_score + amnesia_score} out of 4.

Your test session score: {arms_apart_score + hearing_voice_score + head_lowering_score + test_amnesia_score} out of 4.

Your total score: {arm_rising_score + hand_lock_score + book_hallucination_score + amnesia_score + arms_apart_score + hearing_voice_score + head_lowering_score + test_amnesia_score} out of 8.
